...
const tabsList = [
  ...
  class AppStore extends Component {
    ...
    handleClickAppItem = appId => {
        this.setState(prevState => {
          const { clickCounts } = prevState
          const newCount = clickCounts[appId] ? clickCounts[appId] + 1 : 1
          return {
            clickCounts: {
              ...clickCounts,
              [appId]: newCount
    ...
    render() {
        const {searchInput, activeTabId, clickCounts} = this.state
          ...
          <div className="app-store">
            ...
            <ul className="apps-list">
              {filteredApps.map(eachApp => (
                ...
                key={eachApp.appId} 
                appDetails={eachApp} 
                onClickAppItem={this.handleClickAppItem}
                clickCount={clickCounts[eachApp.appId] || 0}
                 />
